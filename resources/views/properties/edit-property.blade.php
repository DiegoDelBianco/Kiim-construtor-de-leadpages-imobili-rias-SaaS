        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{route('dashboard.properties.update', [$team->id, $property->id])}}">
                        @csrf
                        ...
                        <div class="mt-3">
                            ...
                            <x-select onchange="docType()" 
                                ...
                                :options="$list_types" 
                                :selectedOptions="old('property_type_id', $property->property_type_id)" 
                                required />
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <x-input id="number_street" 
                                ...
                                :value="old('number_street', $property->number_street)" 
                                autofocus />
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <x-input id="neighborhood_related" 
                                ...
                                :value="old('neighborhood_related', $property->neighborhood_related)" 
                                autofocus />
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <x-input id="m2built" 
                                ...
                                :value="old('m2built', $property->m2built)" 
                                autofocus />
                        </div>
                        <?php // furnished ?>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="furnished_yes"
                                :select="(old('furnished', $property->furnished)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="furnished_no"
                                :select="(old('furnished', $property->furnished)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="rent_yes"
                                :select="(old('rent', $property->rent)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="rent_no"
                                :select="(old('rent', $property->rent)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-3">
                            ...
                            <x-input id="rent_iptu" 
                                ...
                                :value="old('rent_iptu', $property->rent_iptu)" 
                                autofcus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="sale_yes"
                                :select="(old('sale', $property->sale)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="sale_no"
                                :select="(old('sale', $property->sale)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="exchange_yes"
                                :select="(old('exchange', $property->exchange)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="exchange_no"
                                :select="(old('exchange', $property->exchange)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :select="(old('its_condominium', $property->its_condominium)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :select="(old('its_condominium', $property->its_condominium)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-3">
                            ...
                            <x-input id="condominium_price" 
                                ...
                                :value="old('condominium_price', $property->condominium_price)" 
                                autofcus />
                        </div>
                        <?php // shared_house ?>
                        <!-- shared_house -->
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="shared_house_yes"
                                :select="(old('shared_house', $property->shared_house)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="shared_house_no"
                                :select="(old('shared_house', $property->shared_house)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-3">
                            <x-label for="description" 
                                :value="__('Descrição')" />
                            <textarea name="description" id="description" >{{old('description', $property->description)}}</textarea>
                        </div>
                        <?php // building ?>
                        <!-- building -->
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="building_yes"
                                :select="(old('building', $property->building)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="building_no"
                                :select="(old('building', $property->building)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-3">
                            ...
                            <x-input id="end_build" 
                                ...
                                :value="old('end_build', $property->end_build)" 
                                autofcus />
                        </div>
                        <?php // status ?>
                        <?php // pets ?>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="pets_yes"
                                :select="(old('pets', $property->pets)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="pets_no"
                                :select="(old('pets', $property->pets)==0)"
                                autofocus /> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"> 
                                <input 
                                    ...
                                    {{ (!old() AND isset($itemsProperty[$item->id]))? 'checked':'' }}
                                    name="item_{{ $item->id }}" 
                                    id="item_{{ $item->id }}" 
                                    value="{{ $item->id }}"> 
