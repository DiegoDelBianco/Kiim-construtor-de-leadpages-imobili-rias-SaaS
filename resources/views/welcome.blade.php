...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased body-site">
            ...
            <div class="container">
                <div class="row">
                    <div class="p-2 col-md-12 text-right">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="p-2 text-sm text-gray-700 dark:text-gray-500 underline">Painel</a>
                        @else
                            <a href="{{ route('login') }}" class="p-2 text-sm text-gray-700 dark:text-gray-500 underline">Entrar</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="p-2 ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Criar conta</a>
                            @endif
                        @endauth
                    </div>
                </div>
        ...
        <section class="container pt-3 pb-5 mt-4 text-center">
            <div class="row">
                <div class="col-md-12">
        ...
        <footer class="container-fluid footer pt-3 pb-2 mt-4">
            <section class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p>Desenvolvido por <a href="https://delbianco.emp.br/">Diego Del Bianco</a></p>
                    </div>
                </div>
            </section>
        </footer>
