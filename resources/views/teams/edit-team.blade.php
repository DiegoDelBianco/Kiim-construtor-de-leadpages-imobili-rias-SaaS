        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('dashboard.teams.update', $team->id) }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="sub_domain" 
                                ...
                                type="text" 
                                name="sub_domain" 
                                :value="old('sub_domain', $team->sub_domain)" 
                                required autofocus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input
                                ...
                                :value="1" 
                                id="show_address_yes"
                                :select="(old('show_address', $team->show_address)==1)"
                                autofocus  /> 
                            ...
                            <x-input
                                ...
                                :value="0" 
                                id="show_address_no"
                                :select="(old('show_address', $team->show_address)==0)"
                                autofocus /> 
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="neighborhood" 
                                ...
                                type="text" 
                                name="neighborhood" 
                                :value="old('neighborhood', $team->neighborhood)" 
                                autofocus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $team->email)" required />
                        </div>
                        <?php // status ?>
                        <?php // visible ?>
